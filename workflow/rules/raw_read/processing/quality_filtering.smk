...
rule quality_filter:
    ...
    output:
        ...
        html=report(
            "{species}/processed/quality_filtered/{sample}_quality_filtered.html",
            #caption="../report/fastp.rst",
            category="quality control",
            subcategory="fastp",
        ),
        json="{species}/processed/quality_filtered/{sample}_quality_filtered.json",
    message: "Quality filtering reads in {input.sample}"
    log:
        "{species}/processed/quality_filtered/{sample}_quality_filtered.log",
    params:
